...
int main()
{
    for (int i = 10; i < 13; i++)
    {
        // Correcting the file paths by using double backslashes
        string textFilename = "C:\\APS\\Qbox\\Q2\\test_cases_with_output\\Q2_testcases\\testcase" + to_string(i) + ".txt";
        string patternFilename = "C:\\APS\\Qbox\\Q2\\test_cases_with_output\\Q2_testcases\\testcase" + to_string(i) + "_pattern.txt";
        string outputFilename = "C:\\APS\\Qbox\\Q2\\test_cases_with_output\\Q2_output\\output" + to_string(i) + ".txt";
